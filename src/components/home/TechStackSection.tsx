  ...
  },
  {
    ...
    mark: (
      <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
        ...
        <path
          d="M9.2 7.5h1.7l4.5 7.2V7.5H17v9h-1.7L10.8 9.3V16.5H9.2v-9z"
          fill="white"
        />
      </svg>
    ),
  },
  {
    ...
    mark: (
      <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
        <path
          fill="currentColor"
          d="M12 2.4 4.8 6.5v11l7.2 4.1 7.2-4.1v-11L12 2.4zm0 1.8 5.5 3.1v7.4L12 17.8l-5.5-3.1V7.3L12 4.2z"
        />
        <path
          fill="currentColor"
          d="M11.1 8.2h1.8c1.5 0 2.5.8 2.5 2.1 0 1-.5 1.6-1.3 1.9l1.5 2.6h-1.8l-1.3-2.3h-.5v2.3H11.1V8.2zm1.7 2.8c.5 0 .8-.3.8-.7s-.3-.7-.8-.7h-.8v1.4h.8z"
        />
      </svg>
    ),
  },
  ...
  },
  {
    ...
    mark: (
      <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
        <path
          fill="currentColor"
          d="M6.8 14.2c0 .3.3.4.6.2 1.9-1.2 4.4-1.9 7-1.9 1.5 0 3 .3 4.4.8.4.1.7-.1.5-.5C17.7 9.7 14.2 7 10.1 7 7.8 7 5.8 7.8 4.3 9.1c-.2.2-.1.5.1.6l2.2 1.4c.2.1.5.1.6-.1.7-.6 1.7-1 2.9-1 1.7 0 3.2.8 3.9 2-.9-.2-1.8-.3-2.8-.3-2.1 0-4 .5-5.4 1.3-.4.2-.6.7-.6 1.2z"
        />
        <path
          fill="currentColor"
          d="M18.4 15.3c-.2-.2-.6-.1-.8.1-.4.5-1 .8-1.4 1-.2.1-.2.3 0 .4 1.3.4 2.5.3 3.4-.1.3-.1.3-.4.1-.6-.4-.4-1-.6-1.3-.8z"
        />
      </svg>
    ),
  },
        ...
        <FadeIn>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 font-display text-3xl font-semibold tracking-[-0.03em] text-foreground sm:text-4xl">
              Built with modern tools teams already trust.
            </h2>
          </div>
        </FadeIn>
